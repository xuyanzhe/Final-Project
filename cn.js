    var lg={  
    downMsg:'<br/><br/><h1>help</h1>you can download concern moving data of pointed service by passing the function of "download the data of track" <br/><br/>Steps：<br/>1.Choose the pointed service you choose to need to download.<br/> 2.input the concern data of downloading you need.<br/> 3.Click the bulk "download tracking file of kml"<br/><br/><span style="color:red;">注意：如果单击“下载”按钮， 出现“没有找到有效的轨迹数据!”提示信息，表示当前没有你需要<br/>下载的数据。 </span><br/><br/>        下载的轨迹文件的格式是Google KML格式，如:“文件名.kml”。安装 Google Earth后。双击KML<br/>文件，会通过Google Earth工具打开。<BR/>        "KML轨迹文件"会将设备的移动痕迹以红线动态的描绘在Google地图上。<br/>        <br/><br/>附注:下载 Google Earth 请点击 <a href="http://dl.google.com/earth/client/ge4/release_4_3/googleearth-win-plus-4.3.7284.3916.exe"><font color="blue">这里</font></a> <br/>',  
    ...
    on:"开启",off:"熄火",  
    msgtit0:"提示",msgtit1:"成功",msgtit2:"失败",
